...
Route::delete('/order/{order_id}', [OrderController::class, 'destroy'])->middleware('protected');
Route::post('/order/{order_id}/status', [OrderController::class, 'changeStatus'])->name('order.status.change')->middleware('protected');
