...
use App\Formatters\OrderDataFormatter;
use App\Models\Food;
use App\Models\Order;
use App\Services\ProductRecombinationService;
...
{
    protected $recombinationService;

    public function __construct(ProductRecombinationService $recombinationService)
    {
        $this->recombinationService = $recombinationService;
    }
    ...
    public function index()
    {
        ...
        $recombinedFoods = $userId?$this->recombinationService->recombineProductsKMeans($userId):[];
        // $recombinedFoods = $userId?$this->recombinationService->recombineProductsKNN($userId):[];
        ...
        return view('food.home',  ['foods' => $foods, 'recombinedFoods'=> $recombinedFoods]);
    }
